...
const Quiz: React.FC = () => {
    ...
    useEffect(() => {
        if (isQuizFinished || !quizStarted) return;
            ...
            {!quizStarted && (
                <div>
                    ...
                    <div className="text-sm py-5">
                        <div>Are you a teacher? Create your own quiz!</div>
                        <div className="text-slate-600">
                            Visit<Link className="p-1 hover:text-slate-900/40 underline hover:underline-offset-4" href={'/factory'}>Quiz Factory</Link>
                        </div>
                    </div>
                </div>
            )}
                    ...
                    <div className="flex gap-5 my-5 mx-5">
                        {isQuizFinished && (
                            <div>
                                ...
                                <div>
                                    You got {result.score} out of {quiz.questions.length * 5} marks.
                                </div>
                                {result.passed ? (
                                    <div>
